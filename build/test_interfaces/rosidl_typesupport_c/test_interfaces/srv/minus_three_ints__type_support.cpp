...
static const _MinusThreeInts_Request_type_support_symbol_names_t _MinusThreeInts_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_interfaces, srv, MinusThreeInts_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interfaces, srv, MinusThreeInts_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, test_interfaces, srv, MinusThreeInts_Request)() {
  return &::test_interfaces::srv::rosidl_typesupport_c::MinusThreeInts_Request_message_type_support_handle;
}
...
static const _MinusThreeInts_Response_type_support_symbol_names_t _MinusThreeInts_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_interfaces, srv, MinusThreeInts_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interfaces, srv, MinusThreeInts_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_test_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, test_interfaces, srv, MinusThreeInts_Response)() {
  return &::test_interfaces::srv::rosidl_typesupport_c::MinusThreeInts_Response_message_type_support_handle;
}
...
static const _MinusThreeInts_type_support_symbol_names_t _MinusThreeInts_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_interfaces, srv, MinusThreeInts)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interfaces, srv, MinusThreeInts)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, test_interfaces, srv, MinusThreeInts)() {
  return &::test_interfaces::srv::rosidl_typesupport_c::MinusThreeInts_service_type_support_handle;
}
